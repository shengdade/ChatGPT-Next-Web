...
const it: PartialLocaleType = {
  ...
  Error: {
    Unauthorized:
      "Accesso non autorizzato, effettua il login tramite la pagina [impostazioni](/#/settings).",
  },
  Auth: {
    Email: "Email:",
    ...
    ResetPasswordSuccess: "Reimpostazione password avvenuta con successo",
    VerificationCode: "Codice di verifica:",
    EnterVerificationCode: "Inserisci il codice di verifica",
    SignIn: "Accedi",
    SignInSuccess: "Accesso avvenuto con successo",
    SignUp: "Registrati",
    SignUpSuccess: "Registrazione avvenuta con successo",
    ...
    SignOutSuccess: "Uscita avvenuta con successo",
  },
  ChatItem: {
