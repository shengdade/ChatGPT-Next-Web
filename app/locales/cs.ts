...
const cs: PartialLocaleType = {
  ...
  Error: {
    Unauthorized:
      "Neoprávněný přístup, prosím přihlaste se na stránce [nastavení](/#/settings).",
  },
  Auth: {
    Email: "Email:",
    ...
    ResetPasswordSuccess: "Heslo úspěšně obnoveno",
    VerificationCode: "Ověřovací kód:",
    EnterVerificationCode: "Zadejte ověřovací kód",
    SignIn: "Přihlásit se",
    SignInSuccess: "Přihlášení úspěšné",
    SignUp: "Zaregistrovat se",
    SignUpSuccess: "Registrace úspěšná",
    ForgotPassword: "Zapomněli jste heslo?",
    NeedAccount: "Nemáte účet?",
    HaveAccount: "Už máte účet?",
    CheckEmailForCode: "Zkontrolujte svůj e-mail pro ověřovací kód",
    ResendCode: "Znovu poslat",
    ConfirmCode: "Potvrdit",
    SignOutConfirm: "Opravdu se chcete odhlásit?",
    SignOutSuccess: "Odhlášení úspěšné",
  },
  ChatItem: {
