...
const de: PartialLocaleType = {
  ...
  Error: {
    Unauthorized:
      "Unberechtigter Zugriff, bitte melden Sie sich über die [Einstellungen](/#/settings) Seite an.",
  },
  Auth: {
    Email: "E-Mail:",
    ...
    CheckEmailForCode: "Überprüfen Sie Ihre E-Mail auf den Verifizierungscode",
