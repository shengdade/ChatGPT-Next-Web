...
const tr: PartialLocaleType = {
  ...
  Error: {
    Unauthorized:
      "Yetkisiz erişim, lütfen [ayarlar](/#/settings) sayfasından giriş yapın.",
  },
  Auth: {
    Email: "E-posta:",
    ...
    SignIn: "Oturum aç",
    SignInSuccess: "Oturum açma başarılı",
    SignUp: "Kaydol",
    SignUpSuccess: "Kayıt başarılı",
    ForgotPassword: "Parolanızı mı unuttunuz?",
    NeedAccount: "Hesabınız yok mu?",
    HaveAccount: "Zaten hesabınız var mı?",
    CheckEmailForCode: "Doğrulama kodu için e-postanızı kontrol edin",
    ResendCode: "Yeniden gönder",
    ConfirmCode: "Onayla",
    SignOutConfirm: "Oturumu kapatmak istediğinizden emin misiniz?",
    SignOutSuccess: "Oturum kapatma başarılı",
  },
  ChatItem: {
